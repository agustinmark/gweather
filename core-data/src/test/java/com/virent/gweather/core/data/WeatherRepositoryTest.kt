...
import com.virent.gweather.core.data.MockData.LATITUDE
import com.virent.gweather.core.data.MockData.LONGITUDE
import com.virent.gweather.core.data.MockData.UNITS
import com.virent.gweather.core.data.MockData.WEATHER_RESPONSE
...
class WeatherRepositoryTest {
    ...
    fun `Delegate Get Current Weather Error`() = runTest {
        ...
        } throws Exception("HTTP 401 Unauthorized")
