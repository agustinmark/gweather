...
val GWeatherIcons.ScatteredClouds: ImageVector
    get() {
        if (_ScatteredClouds != null) {
            return _ScatteredClouds!!
        }
        _ScatteredClouds = ImageVector.Builder(
...
private var _ScatteredClouds: ImageVector? = null
