...
val GWeatherIcons.Thunderstorm: ImageVector
    get() {
        ...
        _Thunderstorm = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFFFFAA45))) {
                moveToRelative(10.858f, 7.069f)
                arcToRelative(0.528f, 0.528f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.489f, -0.326f)
                lineToRelative(-0.643f, -1.554f)
                ...
                arcTo(0.529f, 0.529f, 103.898f, isMoreThanHalf = false, isPositiveArc = true, 6.042f, 14.08f)
                lineToRelative(1.554f, -0.644f)
                arcToRelative(0.53f, 0.53f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.405f, 0.978f)
                lineToRelative(-1.554f, 0.644f)
                arcToRelative(0.527f, 0.527f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.203f, 0.04f)
                close()
                moveTo(18.243f, 10.128f)
                ...
                arcTo(0.529f, 0.529f, 0f, isMoreThanHalf = false, isPositiveArc = true, 14.695f, 6.337f)
                lineToRelative(0.644f, -1.554f)
                arcToRelative(0.529f, 0.529f, 0f, isMoreThanHalf = true, isPositiveArc = true, 0.978f, 0.405f)
                lineToRelative(-0.644f, 1.554f)
                arcToRelative(0.531f, 0.531f, 45f, isMoreThanHalf = false, isPositiveArc = true, -0.489f, 0.326f)
                close()
            ...
            path(fill = SolidColor(Color(0xFFFFDA69))) {
                ...
                arcToRelative(3.32f, 3.32f, 45f, isMoreThanHalf = false, isPositiveArc = true, 3.077f, 2.056f)
                arcToRelative(3.307f, 3.307f, 74.797f, isMoreThanHalf = false, isPositiveArc = true, 0f, 2.548f)
                arcToRelative(3.307f, 3.307f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.802f, 1.801f)
                ...
                arcToRelative(3.333f, 3.333f, 0f, isMoreThanHalf = false, isPositiveArc = true, 3.074f, -4.604f)
            }
            path(fill = SolidColor(Color(0xFFFFAA45))) {
                moveToRelative(20.259f, 21.761f)
                lineToRelative(-1.058f, 3.175f)
                lineToRelative(2.646f, 0f)
                lineToRelative(-1.058f, 3.175f)
                lineToRelative(4.233f, -4.762f)
                lineToRelative(-2.117f, 0f)
                lineToRelative(1.058f, -1.587f)
                close()
            }
            path(fill = SolidColor(Color(0xFF45ABFF))) {
                moveToRelative(12.36f, 28.641f)
                arcToRelative(0.529f, 0.529f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.495f, -0.715f)
                lineToRelative(1.587f, -4.233f)
                arcToRelative(0.529f, 0.529f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.991f, 0.372f)
                lineToRelative(-1.587f, 4.233f)
                arcToRelative(0.53f, 0.53f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.496f, 0.343f)
                close()
                moveTo(14.691f, 30.89f)
                arcToRelative(0.529f, 0.529f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.495f, -0.715f)
                lineToRelative(2.431f, -6.482f)
                arcToRelative(0.529f, 0.529f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.991f, 0.372f)
                lineToRelative(-2.431f, 6.482f)
                arcToRelative(0.531f, 0.531f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.496f, 0.343f)
                close()
                moveTo(18.139f, 30.162f)
                arcTo(0.529f, 0.529f, 0f, isMoreThanHalf = false, isPositiveArc = true, 17.643f, 29.447f)
                lineToRelative(0.968f, -2.58f)
                arcToRelative(0.529f, 0.529f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.991f, 0.372f)
                lineToRelative(-0.968f, 2.58f)
                arcToRelative(0.53f, 0.53f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.496f, 0.343f)
                close()
            ...
            path(fill = SolidColor(Color(0xFF868686))) {
                ...
                arcToRelative(2.906f, 2.906f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.248f, -2.392f)
