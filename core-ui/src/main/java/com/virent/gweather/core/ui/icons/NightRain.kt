...
val GWeatherIcons.NightRain: ImageVector
    get() {
        if (_NightRain != null) {
            return _NightRain!!
        }
        _NightRain = ImageVector.Builder(
            name = "NightRain",
            defaultWidth = 125.dp,
            ...
            path(
                ...
                moveToRelative(14.287f, 10.519f)
                curveToRelative(0.111f, -2.734f, -1.906f, -5.058f, -4.576f, -5.383f)
                curveToRelative(0.981f, 1.688f, 1.155f, 3.809f, 0.274f, 5.716f)
                curveToRelative(-0.841f, 1.819f, -2.455f, 3.031f, -4.27f, 3.439f)
                arcToRelative(5.188f, 5.188f, 45f, isMoreThanHalf = false, isPositiveArc = false, 3.151f, 1.23f)
                curveToRelative(2.878f, 0.116f, 5.305f, -2.123f, 5.421f, -5.001f)
                close()
            }
            path(fill = SolidColor(Color(0xFF45ABFF))) {
                moveToRelative(12.144f, 28.442f)
                arcToRelative(0.53f, 0.53f, 45f, isMoreThanHalf = false, isPositiveArc = true, -0.496f, -0.715f)
                lineToRelative(1.587f, -4.233f)
                arcToRelative(0.53f, 0.53f, 45f, isMoreThanHalf = false, isPositiveArc = true, 0.991f, 0.372f)
                lineToRelative(-1.587f, 4.233f)
                arcToRelative(0.529f, 0.529f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.495f, 0.343f)
                close()
                moveTo(14.475f, 30.692f)
                arcToRelative(0.53f, 0.53f, 135f, isMoreThanHalf = false, isPositiveArc = true, -0.496f, -0.715f)
                lineToRelative(2.431f, -6.483f)
                arcToRelative(0.53f, 0.53f, 45f, isMoreThanHalf = false, isPositiveArc = true, 0.991f, 0.372f)
                lineToRelative(-2.43f, 6.483f)
                arcToRelative(0.529f, 0.529f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.496f, 0.343f)
                close()
                moveTo(17.923f, 29.964f)
                arcToRelative(0.53f, 0.53f, 45f, isMoreThanHalf = false, isPositiveArc = true, -0.496f, -0.715f)
                lineToRelative(2.158f, -5.755f)
                arcToRelative(0.53f, 0.53f, 45f, isMoreThanHalf = false, isPositiveArc = true, 0.991f, 0.372f)
                lineToRelative(-2.158f, 5.755f)
                arcToRelative(0.529f, 0.529f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.495f, 0.343f)
                close()
                moveTo(21.669f, 28.442f)
                arcToRelative(0.53f, 0.53f, 45f, isMoreThanHalf = false, isPositiveArc = true, -0.496f, -0.715f)
                lineToRelative(1.587f, -4.233f)
                arcToRelative(0.53f, 0.53f, 45f, isMoreThanHalf = false, isPositiveArc = true, 0.991f, 0.372f)
                lineToRelative(-1.587f, 4.233f)
            ...
            path(fill = SolidColor(Color(0xFF868686))) {
                ...
                curveToRelative(-0.001f, -2.991f, -2.434f, -5.424f, -5.424f, -5.424f)
                close()
            }
            path(fill = SolidColor(Color(0xFFBFBFBF))) {
                moveToRelative(24.988f, 17.112f)
                ...
                arcToRelative(2.049f, 2.049f, 45f, isMoreThanHalf = false, isPositiveArc = false, -0.519f, -0.073f)
                ...
                arcToRelative(1.866f, 1.866f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.312f, -1.777f)
                close()
            }
