...
val GWeatherIcons.NightClouds: ImageVector
    get() {
        if (_NightClouds != null) {
            return _NightClouds!!
        }
        _NightClouds = ImageVector.Builder(
            name = "NightClouds",
            defaultWidth = 125.dp,
            ...
            path(fill = SolidColor(Color(0xFFFFDA69))) {
                moveToRelative(14.287f, 13.765f)
                ...
                arcToRelative(5.188f, 5.188f, 135f, isMoreThanHalf = false, isPositiveArc = false, 3.151f, 1.23f)
            ...
            path(
                ...
                arcToRelative(3.974f, 3.974f, 45f, isMoreThanHalf = false, isPositiveArc = false, -4.093f, 2.037f)
                ...
                arcToRelative(2.907f, 2.907f, 45f, isMoreThanHalf = false, isPositiveArc = false, -1.248f, -2.392f)
            ...
            path(
                ...
                arcToRelative(2.909f, 2.909f, 135f, isMoreThanHalf = false, isPositiveArc = false, -3.958f, 1.915f)
                ...
                arcToRelative(1.865f, 1.865f, 45f, isMoreThanHalf = false, isPositiveArc = false, -1.312f, -1.777f)
                close()
            }
            path(
                ...
                arcToRelative(4.365f, 4.365f, 0f, isMoreThanHalf = true, isPositiveArc = false, -8.412f, -1.634f)
                arcToRelative(2.909f, 2.909f, 45f, isMoreThanHalf = false, isPositiveArc = false, -3.958f, 1.915f)
                arcToRelative(2.049f, 2.049f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.519f, -0.073f)
                arcToRelative(2.079f, 2.079f, 45f, isMoreThanHalf = false, isPositiveArc = false, -2.079f, 2.079f)
...
private var _NightClouds: ImageVector? = null
